    ...
    return (
        ...
        <div className={cityCardStyles.card_container}>
            ...
            <div className={cityCardStyles.weather_report_block}>
                <img className={cityCardStyles.weather_image} src={getImageLink(currentCity?.weather[0].icon)} fill="#ef6868" alt='weather_report_image'/>
            ...
            <p className={cityCardStyles.weather_feel}>Ощущается как: {Math.round(currentCity?.main.feels_like)}°C</p>
        </div>
    </div>
    )
}